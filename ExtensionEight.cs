...
* Version: 8.0                                                                                                                     *
* Purpose: To create an eighth extension for the storefront to retrive taxes calculated by Avalara                                 *
************************************************************************************************************************************/
...
namespace EighthExtension
{

    public class ExtensionEight : SXIExtension
    {
        ...
        private const string _UNIQUE_NAME = @"ExtensionEight.FixTax.ByAvalara.website.com";
        private const string _DISPLAY_NAME = @"Services: Extension Eight";
        ...
        private const string _AV_COMPANY_NAME = @"AVCompanyName";
